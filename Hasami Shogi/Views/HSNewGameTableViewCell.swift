...
class HSNewGameTableViewCell: UITableViewCell {
    ...
    */
    func buildCellForUser(user: User) -> HSNewGameTableViewCell! {
        ...
        // Customise the font of the text labels
        usernameLabel?.font = HSThemeManager.boldFontWithSize(24)
        bioTextView?.font = HSThemeManager.lightFontWithSize(14)
        ...
        // Add label to centre of overlay
        selectionOverlayLabel.font = HSThemeManager.boldFontWithSize(30)
        selectionOverlayLabel.textColor = UIColor.whiteColor()
