...
class HSGameConstants: NSObject {
    ...
    static var numberOfPiecesPerPlayer : Int {
        get {
            return HSGameConstants.gameType == .HasamiShogi ? 9 : 18
        }
    }
    ...
    static var numberOfPiecesToWin : Int {
        get {
            let piecesToWin = NSUserDefaults.standardUserDefaults().integerForKey("PiecesToWin")
        
            // If not yet initalised, return default (8)
            return (piecesToWin == 0) ? 8 : piecesToWin
        }
